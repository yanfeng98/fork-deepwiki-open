...
def check_ollama_model_exists(model_name: str, ollama_host: str = None) -> bool:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            available_models: list[str] = [model.get('name', '').split(':')[0] for model in models_data.get('models', [])]
            model_base_name: str = model_name.split(':')[0]
            
            is_available: bool = model_base_name in available_models
            if is_available:
